...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#252525] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              <IoDiamondOutline className="text-white" /> Token
                              Vanity Creator
                            </NavLink>
                          </li>
